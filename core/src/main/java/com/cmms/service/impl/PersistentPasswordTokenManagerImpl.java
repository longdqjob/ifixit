...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.cmms.service.impl.PasswordTokenManager#generateRecoveryToken(com.cmms.model.User)
     */
    @Override
    ...
    /**
     * @see com.cmms.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.cmms.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.cmms.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
