...
<style>
    #login {
        background-image: url("../images/engineering-wallpaper.jpg") !important;
    }
</style>
<body id="login">
    ...
    <form method="post" id="loginForm" action="<c:url value='/j_security_check'/>"
        ...
        <h2 class="form-signin-heading" style="text-align: center; font-weight: bold;color: white; ">
        ...
        <input type="text" name="j_username" id="j_username" class="form-control"
            ...
            <label for="rememberMe" class="checkbox" style="align-items: center">
