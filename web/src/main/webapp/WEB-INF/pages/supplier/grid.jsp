...
//-----------------------------------------Grid---------------------------------------------------------------
    var storeGrid = Ext.create('Ext.data.Store', {
        storeId: 'storeGrid',
        fields: ['id', 'code', 'name', 'contact', 'phone', 'email', 'address', 'city', 'country'],
        pageSize: 20,
        autoLoad: true,
        proxy: {
            type: 'ajax',
    ...
    var mygrid = Ext.create('Ext.grid.Panel', {
        title: '<fmt:message key="supplier.list"/>',
        id: 'gridId',
        store: storeGrid,
        border: true,
        layout: 'fit',
...
//        },
        columns: [
            ...
            {text: '<fmt:message key="supplier.code"/>', dataIndex: 'code', flex: 0.5, },
            {text: '<fmt:message key="supplier.name"/>', dataIndex: 'name', flex: 1.5, },
            {text: '<fmt:message key="supplier.contact"/>', dataIndex: 'contact', flex: 1},
            {text: '<fmt:message key="supplier.phone"/>', dataIndex: 'phone', flex: 1},
            {text: '<fmt:message key="supplier.email"/>', dataIndex: 'email', flex: 1},
            {text: '<fmt:message key="supplier.address"/>', dataIndex: 'address', flex: 1},
            {text: '<fmt:message key="supplier.city"/>', dataIndex: 'city', flex: 1},
            {text: '<fmt:message key="supplier.country"/>', dataIndex: 'country', flex: 1},
        ],
        viewConfig: {
            autoFit: true,
            forceFit: true,
