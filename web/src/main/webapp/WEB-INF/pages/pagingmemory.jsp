<%-- 
    Document   : pagingmemory
    Created on : Aug 8, 2017, 9:02:58 AM
    Author     : thuyetlv
--%>
    ...
    Ext.define('Ext.ux.data.PagingMemoryProxy', {
        ...
        read: function (operation, callback, scope) {
            ...
            if (filters && filters.length > 0) {
                ...
                result.totalRecords = result.total;
            }
            // sorting
            ...
            if (operation._start !== undefined && operation._limit !== undefined) {
                result.records = result.records.slice(operation._start, operation._start + operation._limit);
